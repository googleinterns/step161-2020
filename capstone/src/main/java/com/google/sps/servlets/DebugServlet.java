...
public class DebugServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    //example car #1
    makeDriver("Driver Ex1","2020-10-16","morning",4L,"driverEx1@example.com","ABCD123","100 2nd Street, Austin, TX 78701");
    makeRider("Rider A.1", "2020-10-16", "", "2001 E Martin Luther King Jr Blvd, Austin, TX 78702");
    ...
    //example car #2
    makeDriver("Driver Ex2","2020-11-16","morning",3L,"driverEx2@example.com","EFGH123","100 2nd Street, Austin, TX 78701");
    ...
    makeRider("Rider C.2", "2020-11-16", "", "1700 S Lamar Blvd Suite 301, Austin, TX 78704");
  ...
  public static void makeDriver(String first, String day, String times, Long seats, String email, String license, String pollingAddress){
